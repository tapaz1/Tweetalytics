...
export class TwitterService {
  ...
  public authenticate() {
    ...
    return this.http.post(process.env.HTTP_HOST + '/api/authorize', {headers: headers})
      .map((res) => {
  ...
  public search(query) {
    ...
    return this.http.post(process.env.HTTP_HOST + '/api/search', finalQuery, {headers: headers})
  }
